...
function jusoCallBack(roadFullAddr){
	...
	document.facilityInsertForm.fsido.value = strArray[0];		
	document.facilityInsertForm.fgugun.value = strArray[1];
	document.facilityInsertForm.flocation.value = roadFullAddr;
}